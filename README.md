...
Section 12 - Web Scraping and Document Databases - HW

# Table of Contents
Navigating through the repository, and understanding what each, folder/file is.

## Mission_To_Mars Folder
  - Contains the app.py code and the jupyter notebook files for this project.
  ### app.py
    - Contains code for the flask application to create a new HTML page that displays the scraped information from the provided URLs.
